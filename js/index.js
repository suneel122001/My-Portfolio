...
//    setTimeout($.unblockUI, 9000);
   $('#DownloadCV').attr("href", "images/suneel-rajput-cv.pdf");
});
...
$('.instagram').click(function(){
   ...
   setTimeout($.unblockUI, 2000);
   window.location.href = "https://www.instagram.com/shivya_saini?igsh=MTBqa2txNGFmMTlh";       
...
$('.whatsapp').click(function(){
   ...
   setTimeout($.unblockUI, 2000);
   window.location.href = "https://wa.me/+918630513406";        
})
